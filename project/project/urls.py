...
urlpatterns = [
    ...
    # template_name is optional - so the link between the view and template is more obvious.
    ...
    # The views are only for logged in users, using the @login_required decorator
